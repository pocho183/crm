...
@Component({
	selector: 'readercliente',
	templateUrl: './readercliente.component.html',
	styleUrls: ['./readercliente.component.css']
})
export class ReaderClienteComponent implements OnInit {
