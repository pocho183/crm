...
@Component({
	selector: 'referenteazienda',
	templateUrl: './referenteazienda.component.html',
	styleUrls: ['./referenteazienda.component.css']
})
export class ReferenteAziendaComponent implements OnInit {
