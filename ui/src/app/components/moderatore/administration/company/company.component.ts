...
import { CompanyTypes } from '../../../../models/enumTypes';
...
export class CompanyComponent implements OnInit {
	 ...
	 onRowEditInit() {
       let countNewCompany = 0;
		...
		if(countNewCompany == 0) {
			...
			this.company.companyType = CompanyTypes.REFERENTE;
	...
	loadCompanies() {
		this.moderatoreService.moderatoreLoadCompanies().subscribe((response: Company[]) => {
